...
const Cart = () => {
  const { products, currency, cartItems, updateQunatity, setCartItems } =
          ...
          return (
            ...
            >
              ...
              <input
                type="number"
                min={1}
                onChange={(e)=>e.target.value === '' || e.target.vlaue === "0" ? null : updateQunatity(item._id, item.size, e.target.value)}
                value={item.quantity}
